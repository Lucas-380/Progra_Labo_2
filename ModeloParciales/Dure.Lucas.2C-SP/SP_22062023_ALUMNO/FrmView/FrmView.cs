...
namespace FrmView
{
    public partial class FrmView : Form
    {
        ...
        private void FrmView_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            try
            {
                FileManager.Serializar<Cocinero<Hamburguesa>>(this.hamburguesero, "Cocineros.json");
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error al intentar el serializar", "Error al ser", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}